...
public class UnitAttributes : MonoBehaviour
{
    ...
    public int DamageReturn(float AStrength, float DStrength, UnitAttributes Aggressor) {
        ...
        if (Aggressor.Anti_ArmourType1 && Def_ArmourType1) { AStrength = AStrength * 1.35f; }
        if (Aggressor.Anti_ArmourType2 && Def_ArmourType2) { AStrength = AStrength * 1.35f; }
        if (Aggressor.Anti_ArmourType3 && Def_ArmourType3) { AStrength = AStrength * 1.35f; }
        if (Aggressor.Anti_ArmourType4 && Def_ArmourType4) { AStrength = AStrength * 1.35f; }
        if (Aggressor.Anti_ArmourType5 && Def_ArmourType5) { AStrength = AStrength * 1.35f; }
